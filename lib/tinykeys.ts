// https://github.com/jamiebuilds/tinykeys/blob/9223df7d34505386f8650e03d979cd6e89c9b242/src/tinykeys.ts
...
export function createKeybindingsHandler(
  ...
  return (event) => {
    ...
    keyBindings.forEach((keyBinding) => {
      ...
      let matches = currentExpectedPress ? match(event, currentExpectedPress) : false;
